...
class AnswerGenerator:
    ...
    def create_prompt(self, question, contexts, generate_type):
        ...
        Don't make up information that isn't in the document. The answer should be concise and clear, and should be in English.
        """
        if generate_type == "user":
            ...
            {question}
            Please respond in the format {{"question": ...., "answer": ...., "document_id": ....}}, and the answer should be as brief as possible, the examplea are as follow:
            Examples:
            {{"question": "when did the british first land in north america", "answer": "1974", "document_id": [9204, 11727, 6100, 5651, 11804]}}
            {{"question": "name of the actor who plays captain america", "answer": "Christopher Robert Evans", "document_id": [12019, 4608, 711, 2475, 7051]}}
        """
